                                  ...
                                  Container(
                                      ...
                                      child: InkWell(
                                        ...
                                        for(int i = 0; i < getdata.length;i++){
                                             print("days: ${ lawyerData[index].data['days'][i]}");
                                            }
                                             print("days: ${ lawyerData[index].data['days'].length}");
                                             */
                                          _getLawyerName(
                                            lawyerData[index]
                                                .data['lawyer_name'],
                                            ...
                                            //lawyerData[index].data['days'],
                                            //lawyerData[index].data['exp']
                                          );
                                          print(
                                              "name: ${lawyerData[index].data['lawyer_name']}");
                                          // print( "length: ${lawyerData[index].data['exp'].length}");
                                        },
                                      )),
                                ],
                              ),
